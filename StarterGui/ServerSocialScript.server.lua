...
local RobloxReplicatedStorage = Instance.new("Folder", ReplicatedStorage)
...
RobloxReplicatedStorage.Name = 'SocialEvents'
local FFlagRemoveInGameFollowingServer = false

--[[ Remotes ]]--
local RemoteEvent_FollowRelationshipChanged
local RemoteEvent_NewFollower
local RemoteFunc_GetFollowRelationships
if not FFlagRemoveInGameFollowingServer then
...
local FFlagUseCanManageForDeveloperIconServer2 = false
...
local function onPlayerAdded(newPlayer)
	...
	if FFlagUseCanManageForDeveloperIconServer2 then
